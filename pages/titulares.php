    ...
    <div class="card-body">
        <form action="" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-left d-flex row mt-4"
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-end d-flex mt-3">
                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#modalUser"><i class="fas fa-user-plus"></i></button>
            </div>
                ...
                <div class="modal-body">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 justify-content-left d-flex row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            ...
                            <input type="text" class="form-control form-control-sm" id="userName" name="userName" minlength="8">
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <label for="pass">Contraseña <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="text" id="pass" name="pass" class="form-control form-control-sm">
                                <div class="input-group-prepend">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <label for="apellidoM">Rol <span class="text-danger">*</span></label>
